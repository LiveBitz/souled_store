  ...
  return (
    <div className="max-w-2xl mx-auto py-10 px-4 space-y-8">
      ...
      <div className="space-y-1">
        <h1 className="text-3xl font-black tracking-tight text-zinc-950">Brand Tags</h1>
      ...
      <div className="bg-white rounded-2xl border border-zinc-100 p-5 space-y-4">
        <h2 className="text-sm font-bold text-zinc-700 uppercase tracking-wider">New Brand</h2>
